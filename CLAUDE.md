...
|---|---|---|---|
| `server/` | `@devdigest/api` | Fastify 5 + Drizzle/Postgres API | [server/CLAUDE.md](server/CLAUDE.md) |
...
| `e2e/` | `@devdigest/e2e` | deterministic browser e2e (agent-browser) | [e2e/CLAUDE.md](e2e/CLAUDE.md) |
...
| a package's own `CLAUDE.md` (linked in the table above) | you're about to touch files inside that package |
| a package's `docs/` / `specs/` / `INSIGHTS.md` | see that package's own `CLAUDE.md` — same "use when" pattern, one level down |
