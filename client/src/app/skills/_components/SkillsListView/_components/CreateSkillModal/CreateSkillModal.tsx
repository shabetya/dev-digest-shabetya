...
/** Create-skill modal — name/description/type/body, from scratch (source: manual). */
  ...
  return (
    ...
    >
      <div style={s.body}>
        ...
        <FormField label={t("create.fields.description")} required hint={t("create.fields.descriptionHint")}>
          <TextInput
            value={description}
        ...
        <FormField label={t("create.fields.body")} required>
          <Textarea value={body} onChange={setBody} placeholder={t("create.fields.bodyPlaceholder")} rows={8} mono />
        </FormField>
      </div>
    </Modal>
  );
