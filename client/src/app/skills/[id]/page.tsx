/* /skills/:id — Skill editor. Left skill list + Config/Preview/Evals/Stats/
   Versions tabs (Evals/Stats are placeholders — reserved for a later lesson,
   same pattern the Agent Editor uses). Tab state lives in ?tab=. */
"use client";
        ...
        >
          <div style={{ padding: "16px 16px 12px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
              ...
              <Button kind="secondary" size="sm" icon="Plus" onClick={() => router.push("/skills")}>
                {t("page.addSkill")}
              </Button>
            </div>
          </div>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0, minHeight: 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "16px 28px 0", flexShrink: 0 }}>
              ...
              <div style={{ marginLeft: "auto" }}>
                <span title={t("editor.runOnEvalsHint")}>
