...
export const s = {
  ...
  nameLine: { fontSize: 13, fontWeight: 600, color: "var(--text-primary)" } satisfies CSSProperties,
  goToReviewBtn: (clickable: boolean): CSSProperties => ({
    background: "none",
    border: "none",
    padding: 0,
    font: "inherit",
  ...
  modelText: { fontSize: 12, fontWeight: 400, color: "var(--text-muted)" } satisfies CSSProperties,
  errorText: {
    fontSize: 12,
    color: "var(--crit)",
    overflow: "hidden",
