...
/**
 * F1 — pulls module. Transport layer only: parses requests, resolves
 * workspace context, and delegates all business logic to PullsService.
 ...
 *                                  (open/merged/closed) unless derived below.
